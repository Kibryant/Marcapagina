      ...
      <main className="pt-32 pb-20 relative">
        ...
        <section className="container mx-auto max-w-5xl px-4 text-center space-y-10">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed sm:text-2xl font-medium animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            Acompanhe seu progresso, registre sessões com timer e descubra
            estatísticas surpreendentes sobre seu hábito de leitura.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 pt-6 sm:flex-row animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
            <Button
              size="lg"
              asChild
              className="h-16 w-full rounded-full px-10 text-lg font-bold shadow-2xl shadow-primary/40 sm:w-auto relative overflow-hidden group transition-all hover:-translate-y-1 hover:shadow-primary/60"
            >
              <Link href="/signup">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="h-16 w-full rounded-full px-10 text-lg font-bold sm:w-auto border-border/50 bg-background/50 backdrop-blur-md hover:bg-background/80 transition-all"
            >
        ...
        <section className="container mx-auto max-w-5xl px-4 mt-40">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              ...
              >
                <div
                  className={`absolute top-0 right-0 w-32 h-32 blur-3xl rounded-full opacity-0 transition-opacity duration-500 group-hover:opacity-20 ${Feature.bg.replace('/10', '')}`}
                />
